...
public class ActiveEdgeTest extends TestCase{
  public void testBasic(){
    ...
    TagRule r2 = new TagRule("X", Arrays.asList("A", "B", "C"), tagIndex);
    TagRule r3 = new TagRule("X", Arrays.asList("A", "B", "D"), tagIndex);
    TagRule r4 = new TagRule("X", Arrays.asList("A", "D", "C"), tagIndex);
    TagRule r5 = new TagRule("Y", Arrays.asList("A", "B", "C"), tagIndex);
    TagRule r6 = new TagRule("X", new ArrayList<String>(), tagIndex);
    ...
    // test getToEdge
    System.err.println(e6.getToEdge().toString(tagIndex, childIndex));
    System.err.println(e7.getToEdge().toString(tagIndex, childIndex));
