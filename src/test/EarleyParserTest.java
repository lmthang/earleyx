...
//      System.err.println(parser.sprintExpectedCounts());
  ...
  @Test
  public void testSocialDiscourseIO(){
    rootSymbol = "Discourse";
    initParserFromFile(socialDiscourse);
    ...
    if(parser.getDecodeOpt()==1){
      Tree tree = parser.viterbiParse();
      System.err.println(tree.pennString());
      assertEquals(tree.toString(), "( (Discourse (Discourse.pig (Sentence.pig (Topic.pig (T.None (PSEUDO.DOG .dog) (Socials.NotTopical.kid.eyes (PSEUDOKID.EYES kid.eyes) (Socials.NotTopical.kid.hands (Socials.NotTopical.mom.eyes (PSEUDOMOM.EYES mom.eyes) (Socials.NotTopical.mom.hands (Socials.NotTopical.mom.point #)))))) (Topic.pig (T.pig (PSEUDO.PIG .pig) (Socials.Topical.kid.eyes (Socials.Topical.kid.hands (PSEUDOKID.HANDS kid.hands) (Socials.Topical.mom.eyes (Socials.Topical.mom.hands (Socials.Topical.mom.point #)))))) (Topic.None ##))) (Words.pig (Word.pig and) (Words.pig (Word.pig whats) (Words.pig (Word.pig that) (Words.pig (Word.pig is) (Words.pig (Word.pig this) (Words.pig (Word.pig a) (Words.pig (Word.pig puppy) (Words.pig (Word.None dog)))))))))) (Discourse.dog (Sentence.dog (Topic.dog (T.dog (PSEUDO.DOG .dog) (Socials.Topical.kid.eyes (PSEUDOKID.EYES kid.eyes) (Socials.Topical.kid.hands (Socials.Topical.mom.eyes (PSEUDOMOM.EYES mom.eyes) (Socials.Topical.mom.hands (PSEUDOMOM.HANDS mom.hands) (Socials.Topical.mom.point #)))))) (Topic.None (T.None (PSEUDO.PIG .pig) (Socials.NotTopical.kid.eyes (Socials.NotTopical.kid.hands (PSEUDOKID.HANDS kid.hands) (Socials.NotTopical.mom.eyes (Socials.NotTopical.mom.hands (Socials.NotTopical.mom.point #)))))) (Topic.None ##))) (Words.dog (Word.dog woof) (Words.dog (Word.dog dog) (Words.dog (Word.dog woof))))) (Discourse.dog (Sentence.dog (Topic.dog (T.dog (PSEUDO.DOG .dog) (Socials.Topical.kid.eyes (Socials.Topical.kid.hands (Socials.Topical.mom.eyes (Socials.Topical.mom.hands (PSEUDOMOM.HANDS mom.hands) (Socials.Topical.mom.point #)))))) (Topic.None ##)) (Words.dog (Word.dog woof) (Words.dog (Word.dog dog) (Words.dog (Word.dog woof) (Words.dog (Word.dog woof) (Words.dog (Word.dog woof))))))) (Discourse.dog (Sentence.dog (Topic.dog (T.dog (PSEUDO.DOG .dog) (Socials.Topical.kid.eyes (PSEUDOKID.EYES kid.eyes) (Socials.Topical.kid.hands (Socials.Topical.mom.eyes (Socials.Topical.mom.hands (PSEUDOMOM.HANDS mom.hands) (Socials.Topical.mom.point #)))))) (Topic.None ##)) (Words.dog (Word.dog thats) (Words.dog (Word.dog nice)))) (Discourse.None (Sentence.None (Topic.None ##) (Words.None (Word.None come) (Words.None (Word.None here) (Words.None (Word.None you) (Words.None (Word.None come) (Words.None (Word.None here) (Words.None (Word.None you)))))))))))))))");      
    }
