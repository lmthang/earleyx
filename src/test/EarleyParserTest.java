...
//      System.err.println(parser.sprintExpectedCounts());
  ...
  public void testSocialDiscourse(){
    ...
    if(parser.getDecodeOpt()==1){
      Tree tree = parser.viterbiParse();
      System.err.println(tree.pennString());
      assertEquals(tree.toString(), "( (Discourse (Discourse.dog (Sentence.dog (Topic.dog (T.dog (PSEUDO.DOG .dog) (Socials.Topical.kid.eyes (PSEUDOKID.EYES kid.eyes) (Socials.Topical.kid.hands (Socials.Topical.mom.eyes (PSEUDOMOM.EYES mom.eyes) (Socials.Topical.mom.hands (Socials.Topical.mom.point #)))))) (Topic.None (T.None (PSEUDO.PIG .pig) (Socials.NotTopical.kid.eyes (Socials.NotTopical.kid.hands (PSEUDOKID.HANDS kid.hands) (Socials.NotTopical.mom.eyes (Socials.NotTopical.mom.hands (Socials.NotTopical.mom.point #)))))) (Topic.None ##))) (Words.dog (Word.None (Word and)) (Words.dog (Word.None (Word whats)) (Words.dog (Word.None (Word that)) (Words.dog (Word.None (Word is)) (Words.dog (Word.None (Word this)) (Words.dog (Word.None (Word a)) (Words.dog (Word.None (Word puppy)) (Words.dog (Word.None (Word dog))))))))))) (Discourse.dog (Sentence.dog (Topic.dog (T.dog (PSEUDO.DOG .dog) (Socials.Topical.kid.eyes (PSEUDOKID.EYES kid.eyes) (Socials.Topical.kid.hands (Socials.Topical.mom.eyes (PSEUDOMOM.EYES mom.eyes) (Socials.Topical.mom.hands (PSEUDOMOM.HANDS mom.hands) (Socials.Topical.mom.point #)))))) (Topic.None (T.None (PSEUDO.PIG .pig) (Socials.NotTopical.kid.eyes (Socials.NotTopical.kid.hands (PSEUDOKID.HANDS kid.hands) (Socials.NotTopical.mom.eyes (Socials.NotTopical.mom.hands (Socials.NotTopical.mom.point #)))))) (Topic.None ##))) (Words.dog (Word.None (Word woof)) (Words.dog (Word.None (Word woof)) (Words.dog (Word.None (Word woof)))))) (Discourse.dog (Sentence.dog (Topic.dog (T.dog (PSEUDO.DOG .dog) (Socials.Topical.kid.eyes (Socials.Topical.kid.hands (Socials.Topical.mom.eyes (Socials.Topical.mom.hands (PSEUDOMOM.HANDS mom.hands) (Socials.Topical.mom.point #)))))) (Topic.None ##)) (Words.dog (Word.None (Word woof)) (Words.dog (Word.None (Word woof)) (Words.dog (Word.None (Word woof)) (Words.dog (Word.None (Word woof)) (Words.dog (Word.None (Word woof)))))))) (Discourse.dog (Sentence.dog (Topic.dog (T.dog (PSEUDO.DOG .dog) (Socials.Topical.kid.eyes (PSEUDOKID.EYES kid.eyes) (Socials.Topical.kid.hands (Socials.Topical.mom.eyes (Socials.Topical.mom.hands (PSEUDOMOM.HANDS mom.hands) (Socials.Topical.mom.point #)))))) (Topic.None ##)) (Words.dog (Word.None (Word thats)) (Words.dog (Word.None (Word nice))))) (Discourse (Discourse.None (Sentence.None (Topic.None ##) (Words.None (Word.None (Word come)) (Words.None (Word.None (Word here)) (Words.None (Word.None (Word you)) (Words.None (Word.None (Word come)) (Words.None (Word.None (Word here)) (Words.None (Word.None (Word you)))))))))))))))))");
