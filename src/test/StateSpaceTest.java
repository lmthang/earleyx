...
public class StateSpaceTest extends TestCase{
  public void testBasic(){
    ...
    ss.addEdge(e1);
    assertEquals(ss.toString(), "<active=0, via=2, to=3 (X -> . a b c)>\n<passive=1 (X -> .)>\n<passive=2 (a -> .)>\n<active=3, via=4, to=5 (X -> a . b c)>\n<passive=4 (b -> .)>\n<active=5, via=6, to=1 (X -> a b . c)>\n<passive=6 (c -> .)>\n");
    
    ss.addEdge(e2);
    assertEquals(ss.toString(), "<active=0, via=2, to=3 (X -> . a b c)>\n<passive=1 (X -> .)>\n<passive=2 (a -> .)>\n<active=3, via=4, to=5 (X -> a . b c)>\n<passive=4 (b -> .)>\n<active=5, via=6, to=1 (X -> a b . c)>\n<passive=6 (c -> .)>\n<active=7, via=2, to=8 (X -> . a b d)>\n<active=8, via=4, to=9 (X -> a . b d)>\n<active=9, via=10, to=1 (X -> a b . d)>\n<passive=10 (d -> .)>\n");
    
    ss.addEdge(e3);
    assertEquals(ss.toString(), "<active=0, via=2, to=3 (X -> . a b c)>\n<passive=1 (X -> .)>\n<passive=2 (a -> .)>\n<active=3, via=4, to=5 (X -> a . b c)>\n<passive=4 (b -> .)>\n<active=5, via=6, to=1 (X -> a b . c)>\n<passive=6 (c -> .)>\n<active=7, via=2, to=8 (X -> . a b d)>\n<active=8, via=4, to=9 (X -> a . b d)>\n<active=9, via=10, to=1 (X -> a b . d)>\n<passive=10 (d -> .)>\n<active=11, via=2, to=13 (Y -> . a b c)>\n<passive=12 (Y -> .)>\n<active=13, via=4, to=14 (Y -> a . b c)>\n<active=14, via=6, to=12 (Y -> a b . c)>\n");
    
    assertEquals(ss.getActiveIndices().toString(), "[0, 5]");
    assertEquals(tagIndex.toString(), "[0=X,1=a,2=b,3=c,4=d,5=Y]");
    assertEquals(ss.getActiveEdges().toString(), "[0, 3, 5, 7, 8, 9, 11, 13, 14]");
    assertEquals(ss.getPassiveEdges().toString(), "[1, 2, 4, 6, 10, 12]");
  }
}
