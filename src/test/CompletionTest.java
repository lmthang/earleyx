...
public class CompletionTest extends TestCase{
  ...
  public void testBasic(){
    ...
    assertEquals(sb.toString(), "ROOT, []\nA, [(A -> . A B, A -> . B, 1.0), (ROOT -> . A, ROOT -> ., 1.0)]\nB, [(C -> . B, C -> ., 1.0638297872340425), (B -> . C, B -> ., 0.3191489361702127), (A -> . B C, A -> . C, 1.0638297872340425), (A -> . B, A -> ., 1.0638297872340425), (A -> . C, A -> ., 0.3191489361702127)]\nC, [(C -> . B, C -> ., 0.21276595744680848), (B -> . C, B -> ., 1.0638297872340425), (A -> . C, A -> ., 1.0638297872340425), (A -> . B, A -> ., 0.21276595744680848), (A -> . B C, A -> . C, 0.21276595744680848)]\nA1, [(A -> . A1, A -> ., 1.0), (A -> . A B, A -> . B, 0.29999999999999993), (ROOT -> . A, ROOT -> ., 0.29999999999999993)]\nA2, [(A1 -> . A2, A1 -> ., 1.0), (A -> . A1, A -> ., 1.0), (A -> . A B, A -> . B, 0.29999999999999993), (ROOT -> . A, ROOT -> ., 0.29999999999999993)]\nD, [(C -> . B, C -> ., 0.14893617021276595), (C -> . D, C -> ., 1.0), (B -> . D E, B -> . E, 1.0), (B -> . C, B -> ., 0.7446808510638298), (A -> . C, A -> ., 0.7446808510638298), (A -> . B, A -> ., 0.14893617021276595), (A -> . B C, A -> . C, 0.14893617021276595)]\nE, [(B -> . E, B -> ., 1.0)]\n");    
  }
  ...
  public void testFragmentBasic(){
    ...
    assertEquals(sb.toString(), "ROOT, []\nA, [(A -> . A _b, A -> . _b, 1.0), (A -> . A B, A -> . B, 1.0), (ROOT -> . A, ROOT -> ., 1.0)]\nB, [(C -> . B, C -> ., 1.0638297872340425), (A -> . B C, A -> . C, 1.0638297872340425), (A -> . B, A -> ., 1.0638297872340425), (A -> . C, A -> ., 0.3191489361702127), (B -> . C, B -> ., 0.3191489361702127)]\nC, [(B -> . C, B -> ., 1.0638297872340425), (A -> . C, A -> ., 1.0638297872340425), (A -> . B C, A -> . C, 0.21276595744680848), (A -> . B, A -> ., 0.21276595744680848), (C -> . B, C -> ., 0.21276595744680848)]\nA1, [(A -> . A1, A -> ., 1.0), (A -> . A _b, A -> . _b, 0.29999999999999993), (A -> . A B, A -> . B, 0.29999999999999993), (ROOT -> . A, ROOT -> ., 0.29999999999999993)]\nA2, [(A1 -> . A2, A1 -> ., 1.0), (A -> . A1, A -> ., 1.0), (A -> . A _b, A -> . _b, 0.29999999999999993), (A -> . A B, A -> . B, 0.29999999999999993), (ROOT -> . A, ROOT -> ., 0.29999999999999993)]\nD, [(C -> . D, C -> ., 1.0), (B -> . C, B -> ., 0.7446808510638298), (B -> . D E, B -> . E, 1.0), (A -> . C, A -> ., 0.7446808510638298), (A -> . B C, A -> . C, 0.14893617021276595), (A -> . B, A -> ., 0.14893617021276595), (C -> . B, C -> ., 0.14893617021276595)]\nE, [(B -> . E, B -> ., 1.0)]\n");    
  }
}
