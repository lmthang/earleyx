...
public class BaseEdge {
  ...
  public BaseEdge(String motherStr, List<String> childStrs, 
  ...
  public BaseEdge(int mother, List<Integer> children){
    this.mother = mother;
  ...
  /**
   * Compare edges, ignoring children before the dot position
   * @param otherEdge
   * @param dot
   * @return
   */
  public boolean equals(BaseEdge otherEdge, int dot, int otherDot){
    // compare mother
    ...
    // compare children
    List<Integer> thisChildren = getChildren(dot);
    List<Integer> otherChildren = otherEdge.getChildren(otherDot);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BaseEdge)) { // check class
      return false;
    } 

    BaseEdge otherEdge = (BaseEdge) o;
    return equals(otherEdge, 0, 0);
  }

  public int hashCode(int dot){
    int result = mother;
    for(int child : getChildren(dot)){
